...
public class ActivityHttpWCookiesFunctionality extends ActivityHttpFunctionality implements
    ...
    public ActivityHttpWCookiesFunctionality(HostActivity activity, AbstractHttpClient httpClient) {
