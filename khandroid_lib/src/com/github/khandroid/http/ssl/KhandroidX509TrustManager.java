...
class KhandroidX509TrustManager implements javax.net.ssl.X509TrustManager {
	private ArrayList<X509TrustManager> mX509TrustManagers = new ArrayList<X509TrustManager>();

	protected KhandroidX509TrustManager(InputStream keyStore, String keyStorePassword) throws GeneralSecurityException {
	...
	public void checkServerTrusted(X509Certificate[] chain, String authType) throws CertificateException {
        ...
        for( X509TrustManager tm : mX509TrustManagers ) {
            try {
                ...
                KhandroidLog.d("Certificate is trusted.");
                ok = true;
                break;
        ...
        if (!ok) { 
            KhandroidLog.d("Certificate is NOT trusted.");
